...
\begin{frame}[fragile=singleslide]\frametitle{Uloha 2. a.b.c.}
Obsah:
\begin{itemize}
\item Uvod
\item Gamifikacia v zdravi
\item Benefity
	\begin{itemize}
	\item biro
	\item ucenie
...
\begin{frame}[fragile=singleslide]\frametitle{Uloha 2. d.}
\includegraphics[width=1.0\linewidth]{Snap.png}
\end{frame}
